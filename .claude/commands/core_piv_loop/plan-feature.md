...
- Register new components
  - ⚠️ **CRITICAL: Preserve import order for side-effect imports** (use `# ruff: noqa: I001`)
  - Verify with: `uv run python -c "from app.main import app; print('OK')"`
...
- **GOTCHA**: {Known issues or constraints to avoid}
  - **Example (Vault Paths)**: Always calculate relative paths using `vault_manager.vault_root`:
    ```python
